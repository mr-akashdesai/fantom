      ...
      {!!movie && (
        <div className='hero__container'>
          <img
            ...
            src={`${process.env.MOVIE_DB_IMAGE_URL}${movie.backdrop_path}`}
          ...
          <div className='hero__tagline'>
            <i>{movie.tagline.substring(0, movie.tagline.length - 1)}</i>&nbsp;
          ...
          <div className='hero__overview'>{movie.overview}</div>
        </div>
      )}
    </>
  )
